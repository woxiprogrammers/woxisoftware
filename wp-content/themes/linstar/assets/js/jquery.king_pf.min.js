...
wrap.on({
    'mouseover.king_pf': function() {
        wrap.addClass('cbp-l-filters-dropdownWrap-open');
    },
    'mouseleave.king_pf': function() {
...
filtersCallback = function(me) {
    ...
    wrap.trigger('mouseleave.king_pf');
};
} else {
filtersCallback = function(me) {
...
filtersContainer.on('click.king_pf', '.cbp-filter-item', function() {
var me = $(this);
...
var match = /#king_pff=(.*?)([#|?&]|$)/gi.exec(location.href),
    item;
if (match !== null) {
...
gridContainer.on('filterComplete.king_pf', function() {
